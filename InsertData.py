...
storage_bucket = 'cloud_project-1'
...
# Path/nome do bucket e da tabela:
uri_storage = 'gs://cloud_project-1/'
dataset_id = 'cloud-storage-289515.storage_dataset'
...
bf.BigQueryFuncs.loadPostTableData(storage_file_name, uri_storage, dataset_id)
...
bf.BigQueryFuncs.listPostsTableRows(5, dataset_id)